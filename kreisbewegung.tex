...
\begin{table}[h!]
\centering
\begin{tabular}{m{2cm} c m{0.35\textwidth}}
Körper	& Achse	& $I$ \\
\hline
& & \\
Kreisring, dünn &
	\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.7]{traeg-kreisring-duenn.pdf}
	\end{minipage} &
		\begin{itemize}
		\item[x] $m \cdot r^2$
...
Kreisring &
	\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.7]{traeg-kreisring.pdf}
	\end{minipage} &
		\begin{itemize}
...
Kreisbogen &
	\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.7]{traeg-kreisbogen.pdf}
	\end{minipage} &
		\begin{itemize}
		\item[x] $\frac{m}{r^2} 
...
Kreissektor &
	\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.7]{traeg-kreissektor.pdf}
	\end{minipage} &
		\begin{itemize}
		\item[x] $\frac{m}{4} r^2  
			\left(1-\frac{sin(\alpha)}{\alpha} \right)$
...
Kreisscheibe, dünn &
	\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.7]{traeg-kreisscheibe-duenn.pdf}
	\end{minipage} &
		\begin{itemize}
		\item[x] $\frac{m}{2} r^2$
		\item[y] $\frac{m}{4} r^2$
